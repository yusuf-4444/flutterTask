...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProdcutsState<T>);
}
...
/// @nodoc
class $ProdcutsStateCopyWith<T,$Res>  {
$ProdcutsStateCopyWith(ProdcutsState<T> _, $Res Function(ProdcutsState<T>) __);
}


/// Adds pattern-matching-related methods to [ProdcutsState].
extension ProdcutsStatePatterns<T> on ProdcutsState<T> {
...
class _Initial<T> implements ProdcutsState<T> {
  const _Initial();
...
@override
String toString() {
  return 'ProdcutsState<$T>.initial()';
}
...
class _Loading<T> implements ProdcutsState<T> {
  const _Loading();
...
@override
String toString() {
  return 'ProdcutsState<$T>.loading()';
}
...
class _Success<T> implements ProdcutsState<T> {
  const _Success(this.data);
  

 final  T data;

/// Create a copy of ProdcutsState
...
@override
String toString() {
  return 'ProdcutsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $ProdcutsStateCopyWith<T, $Res> {
...
class _Failure<T> implements ProdcutsState<T> {
...
@override
String toString() {
  return 'ProdcutsState<$T>.failure(error: $error)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<T,$Res> implements $ProdcutsStateCopyWith<T, $Res> {
